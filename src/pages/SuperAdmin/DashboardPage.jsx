    ...
    return (
      <div>
                      ...
                      {hasHighPriorityTasks && (
                        <div
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            const dateStr = `${currentYear}-${String(currentMonth + 1).padStart(2, "0")}-${String(day).padStart(2, "0")}`;
                            navigate("/task-management", { state: { date: dateStr, priority: "High" } });
                          }}
                        >
                            ...
                            <div className="relative group/taskdot flex-shrink-0">
                              <div
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  const dateStr = `${currentYear}-${String(currentMonth + 1).padStart(2, "0")}-${String(day).padStart(2, "0")}`;
                                  navigate(`/task-management?date=${dateStr}`);
                                }}
                              />
                              {/* Professional hover card */}
                            ...
                            <div className="relative group/evtdot flex-shrink-0">
                              <div
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  const dateStr = `${currentYear}-${String(currentMonth + 1).padStart(2, "0")}-${String(day).padStart(2, "0")}`;
                                  navigate("/calendar", { state: { date: dateStr } });
                                }}
                              />
                              {/* Professional hover card */}
            ...
            data
              ...
              .map((event, index) => (
                <div key={index} className="flex items-center gap-2 text-xs">
                  ...
                  ></div>
                  <span className="text-content-secondary whitespace-nowrap flex-shrink-0">
        ...
        <div className="mt-2 flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
          <span className="text-[9px] font-semibold uppercase tracking-wide text-gray-400 dark:text-gray-500 mr-1">Legend:</span>
          <div className="flex items-center gap-1">
            <div className="w-2 h-2 rounded-full bg-red-500 flex-shrink-0" />
            <span className="text-[9px] text-gray-500 dark:text-gray-400">Overdue tasks</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-2 h-2 rounded-full bg-orange-500 flex-shrink-0" />
            <span className="text-[9px] text-gray-500 dark:text-gray-400">Due today</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-2 h-2 rounded-full bg-blue-500 flex-shrink-0" />
            <span className="text-[9px] text-gray-500 dark:text-gray-400">Meetings</span>
          </div>
          <div className="flex items-center gap-1">
            <FaFlag className="text-[8px] flex-shrink-0" style={{ color: "#ef4444" }} />
            <span className="text-[9px] text-gray-500 dark:text-gray-400">High-priority task</span>
          </div>
          <span className="text-[9px] text-gray-400 dark:text-gray-500 ml-1 italic">Click any dot or flag to navigate</span>
        </div>
      </div>
    );
  };

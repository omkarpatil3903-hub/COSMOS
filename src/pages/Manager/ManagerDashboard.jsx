                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="rounded w-full border border-gray-200 dark:border-white/20 px-2 py-1 text-sm bg-white dark:bg-[#1F2234] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                                    value={remDate}

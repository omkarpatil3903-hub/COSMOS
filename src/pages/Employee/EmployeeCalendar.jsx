          ...
          <div className="mt-1 space-y-1">
            {dayItems.slice(0, 2).map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className={`text-xs p-1.5 rounded-md ${isPast ? "bg-gray-200 dark:bg-gray-800 text-gray-500 dark:text-gray-400" : typeBadge
                  ...
                  getItemsForDate(selectedDate).map((item) => {
                    ...
                    if (isEvent) {
                      ...
                      return (
                        <div
                          key={item.id}
                          className="border-2 rounded-lg p-3 space-y-2 hover:shadow-lg transition-all duration-200 bg-white dark:bg-[#1e1e2d] dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-500"
                        >

      ...
      >
        <div className="flex items-center w-full">
          ...
          >
            ...
            {!hideHeaderActions && (
              <div
                className="relative flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity"
                ref={menuRef}
                  ...
                  <div
                    className={`absolute ${
                      title === "Done"
                        ...
                        : "top-0 left-full"
                    } w-30 bg-white rounded-md shadow-lg z-50 border border-gray-200`}

...
const SidebarLink = ({ to, icon, text, isCollapsed, onNavigate }) => {
  ...
  const getIconColor = (to) => {
    if (accent === "black") {
      ...
      if (to === "/manager" || to === "/manager/dashboard" || to === "")
      ...
      if (to.includes("knowledge")) return "text-cyan-400";
      if (to.includes("expenses")) return "text-orange-400";
...
function ManagerLayout() {
  ...
  useEffect(() => {
    const pathToTitle = {
      "/manager": "COSMOS | Dashboard",
      "/manager/projects": "COSMOS | Projects",
      "/manager/tasks": "COSMOS | Task Management",
      "/manager/reports": "COSMOS | Reports",
      "/manager/calendar": "COSMOS | Calendar",
      "/manager/knowledge-management": "COSMOS | Knowledge Management",
      "/manager/expenses": "COSMOS | Team Expenses",
      "/manager/settings/theme": "COSMOS | Settings | Theme",
      "/manager/settings/profile": "COSMOS | Settings | Profile",
    };

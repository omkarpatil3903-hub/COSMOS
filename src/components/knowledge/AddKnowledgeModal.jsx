              ...
              <div className="rounded-lg border border-subtle [.dark_&]:border-white/10 bg-white [.dark_&]:bg-slate-800/40 backdrop-blur-sm p-4 shadow-sm h-full flex flex-col gap-4">
                ...
                <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-3 text-xs text-gray-500 [.dark_&]:text-gray-400 bg-blue-50 [.dark_&]:bg-blue-900/10 border border-blue-200 [.dark_&]:border-blue-800/30 rounded-lg p-2.5">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-blue-600 [.dark_&]:text-blue-400">PDF, DOC, DOCX, TXT, XLS, XLSX, PPT, PPTX</p>
                        </div>
                      </div>
                    </div>

...
/**
 * DateRangeCalendar
 * - Month grid calendar with click-drag range selection
 * - Emits { start, end, days } where dates are YYYY-MM-DD
 */
export default function DateRangeCalendar({
  ...
  className = "",
  initialMonth,
  compact = false, // render smaller variant
  accent = "indigo", // tailwind color keyword for selection accents
}) {
